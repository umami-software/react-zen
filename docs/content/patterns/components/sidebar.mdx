...
<Example backgroundColor="transparent">
  <Box height="90" border borderRadius="lg" overflow="hidden" backgroundColor="surface-base">
    <Row height="100%">
      <Sidebar>
        <Column>
          ...
          <SidebarNav>
            <Box paddingX="3" paddingY="2">
              <Text size="xs" color="muted" weight="semibold">MAIN</Text>
            </Box>
            <SidebarItem icon={<Lucide.Home />} label="Dashboard" isSelected />
            <SidebarItem icon={<Lucide.Users />} label="Users" />
            <Box paddingX="3" paddingY="2" marginTop="4">
              <Text size="xs" color="muted" weight="semibold">SETTINGS</Text>
            </Box>
