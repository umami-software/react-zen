          ...
          {group.options.map((option) => (
            <Row key={option.id} alignItems="center" justifyContent="space-between">
              ...
              {option.count !== undefined && (
                <Text size="xs" color="muted">{option.count}</Text>
              )}
            </Row>
          ))}
        </Column>
...
<Example>
  <Column gap="4">
    <ActiveFilters
      groups={[
        { id: 'category', label: 'Category', options: [{ id: 'electronics', label: 'Electronics' }, { id: 'clothing', label: 'Clothing' }] },
        { id: 'brand', label: 'Brand', options: [{ id: 'apple', label: 'Apple' }] },
      ]}
      selectedFilters={{ category: ['electronics', 'clothing'], brand: ['apple'] }}
      onRemove={(groupId, optionId) => console.log('Remove:', groupId, optionId)}
    />
  </Column>
    ...
    <Column gap="4">
      ...
      <Column>
        <Row alignItems="center" justifyContent="space-between" paddingY="2" className="cursor-pointer">
          ...
          <Icon size="sm" color="muted"><Lucide.ChevronDown /></Icon>
        </Row>
      </Column>
      <Column>
        <Row alignItems="center" justifyContent="space-between" paddingY="2" className="cursor-pointer">
          <Text size="sm" weight="medium">Price Range</Text>
          <Icon size="sm" color="muted"><Lucide.ChevronDown /></Icon>
        </Row>
      </Column>
    </Column>
