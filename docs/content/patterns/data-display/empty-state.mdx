...
<Example>
  <Column alignItems="center" justifyContent="center" padding="8" gap="4">
    ...
    <Column alignItems="center" gap="2">
      ...
      <Box maxWidth="20rem"><Text color="muted" align="center">We couldn't load this content. Please try again.</Text></Box>
    </Column>
    <Column gap="2" alignItems="center">
...
<Example>
  <Column alignItems="center" justifyContent="center" padding="8" gap="4">
    ...
    <Column alignItems="center" gap="2">
      ...
      <Box maxWidth="20rem"><Text color="muted" align="center">Create a new project to get started building something amazing.</Text></Box>
    </Column>
    <Column gap="2" alignItems="center">
