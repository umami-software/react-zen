...
declare const inputField: tailwind_variants.TVReturnType<{
    variant: {
        default: string;
        quiet: string;
    };
...
interface ButtonGroupTextProps extends HTMLAttributes<HTMLDivElement> {
    render?: RenderProp<ButtonGroupTextRenderProps>;
}
interface ButtonGroupTextRenderProps {
    className: string;
    children?: ReactNode;
    'data-slot': 'button-group-text';
    [key: string]: unknown;
}
declare function ButtonGroupText({ className, render, children, ...props }: ButtonGroupTextProps): react.ReactElement<unknown, string | react.JSXElementConstructor<any>>;
interface ButtonGroupSeparatorProps extends SeparatorProps {
}
...
interface ListSeparatorProps extends Select$1.Separator.Props {
}
declare function ListSeparator({ className, ...props }: ListSeparatorProps): react_jsx_runtime.JSX.Element;
...
interface CommandDialogProps extends Omit<CommandProps, 'title'> {
    isOpen?: boolean;
    onOpenChange?: (open: boolean) => void;
    title?: ReactNode;
    description?: ReactNode;
}
declare function CommandDialog({ isOpen, onOpenChange, title, description, children, ...props }: CommandDialogProps): react_jsx_runtime.JSX.Element;
...
interface CopyButtonProps extends Omit<ButtonProps, 'children' | 'onClick' | 'onPress' | 'size' | 'type' | 'value' | 'variant'> {
    value?: string | (() => string);
    timeout?: number;
}
declare function CopyButton({ value, timeout, className, ...props }: CopyButtonProps): react_jsx_runtime.JSX.Element;
...
declare function DatePicker({ id, value, defaultValue, minValue, maxValue, label, placeholder, locale, isDisabled, isReadOnly, formatOptions, onChange, buttonProps, calendarProps, className, }: DatePickerProps): react_jsx_runtime.JSX.Element;
...
interface TooltipProps extends Omit<Tooltip$1.Positioner.Props, 'children' | 'className'> {
    ...
    showArrow?: boolean;
    className?: string;
    placement?: Tooltip$1.Positioner.Props['side'];
}
declare function Tooltip({ children, className, placement, side, sideOffset, showArrow, ...props }: TooltipProps): react_jsx_runtime.JSX.Element;
...
interface InputGroupProps extends HTMLAttributes<HTMLDivElement>, InputFieldVariants {
}
...
declare const InputGroupButton: react.ForwardRefExoticComponent<Omit<InputGroupButtonProps, "ref"> & react.RefAttributes<HTMLButtonElement>>;
declare const InputGroupText: react.ForwardRefExoticComponent<HTMLAttributes<HTMLSpanElement> & react.RefAttributes<HTMLSpanElement>>;
declare const InputGroupInput: react.ForwardRefExoticComponent<InputHTMLAttributes<HTMLInputElement> & react.RefAttributes<HTMLInputElement>>;
declare const InputGroupTextarea: react.ForwardRefExoticComponent<TextareaHTMLAttributes<HTMLTextAreaElement> & react.RefAttributes<HTMLTextAreaElement>>;
...
interface MenuSeparatorProps extends Menu$1.Separator.Props {
}
...
interface NavbarLinkProps extends NavigationMenu.Link.Props {
}
/** A semantic navigation link. Renders an `<a>` element and integrates with keyboard navigation. */
declare function NavbarLink({ className, ...props }: NavbarLinkProps): react_jsx_runtime.JSX.Element;
...
declare function NumberField({ label, placeholder, minValue, maxValue, isDisabled, isReadOnly, isRequired, formatOptions, onChange, className, id, ...props }: NumberFieldProps): react_jsx_runtime.JSX.Element;
...
declare function OTPField({ length, label, isDisabled, isReadOnly, isRequired, onChange, onComplete, className, id, ...props }: OTPFieldProps): react_jsx_runtime.JSX.Element;
...
declare function DialogTrigger({ children, overlayType, isOpen, defaultOpen, onOpenChange, }: DialogTriggerProps): react_jsx_runtime.JSX.Element;
...
declare function Select({ value, defaultValue, label, placeholder, isLoading, isDisabled, allowSearch, searchValue, searchDelay, isFullscreen, maxHeight, showIcon, alignItemWithTrigger, onSearch, onChange, buttonProps, listProps, popoverProps, renderValue, className, children, items, onOpenChange, id, ...props }: SelectProps): react_jsx_runtime.JSX.Element;
...
declare function Switch({ label, children, className, isSelected, defaultSelected, isDisabled, onChange, value, id, ...props }: SwitchProps): react_jsx_runtime.JSX.Element;
