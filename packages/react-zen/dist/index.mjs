...
function Button({
  ...
  const isNativeButton = nativeButton ?? (render === void 0 || isValidElement(render) && render.type === "button");
...
function Form({
  ...
  return /* @__PURE__ */ jsxs(FormProvider, { ...formValues, children: [
    error && /* @__PURE__ */ jsx(Alert, { variant: "danger", children: /* @__PURE__ */ jsx(AlertTitle, { className: "justify-self-center", children: error instanceof Error ? error?.message : error }) }),
    /* @__PURE__ */ jsx(
      "form",
      {
        ...props,
...
function SkeletonText({
  ...
  return /* @__PURE__ */ jsx(Column, { gap: "2", width: "100%", ...props, children: lineKeys.map((key, index) => /* @__PURE__ */ jsx(
    Skeleton,
    {
      height: lineHeight,
