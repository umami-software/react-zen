...
import type { Breakpoint, Responsive } from '@/lib/types';
...
const spaceXMap: Record<string, string> = {
  '0': 'space-x-0',
  px: 'space-x-px',
  '0.5': 'space-x-0.5',
  '1': 'space-x-1',
...
const spaceYMap: Record<string, string> = {
  '0': 'space-y-0',
  px: 'space-y-px',
  '0.5': 'space-y-0.5',
  '1': 'space-y-1',
...
export function mapSpace(value: Responsive<string> | undefined, axis: 'x' | 'y'): string {
